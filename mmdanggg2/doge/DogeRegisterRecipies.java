...
public class DogeRegisterRecipies {
	public static void register() {
		...
		GameRegistry.addRecipe(new ItemStack(Doge.gpu, 1), "RBR", "CGC", "III", 'R', new ItemStack(Item.redstone), 'G', new ItemStack(Item.ingotGold), 'B', new ItemStack(Block.blockRedstone), 'C', new ItemStack(Item.comparator), 'I', new ItemStack(Item.ingotIron));
		
		GameRegistry.addRecipe(new ItemStack(Doge.miningRig, 1), "CDC", "GIG", "RPR", 'R', new ItemStack(Item.redstone), 'G', new ItemStack(Item.ingotGold), 'P', new ItemStack(Item.pickaxeIron), 'I', new ItemStack(Block.blockIron), 'C', new ItemStack(Item.comparator), 'D', new ItemStack(Doge.dogecoin));
